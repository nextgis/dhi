...
def resample(hdf):
    ...
    cmd = "gdal_edit -a_srs \"EPSG:4326\" " + f_out_name
    os.system(cmd)
    
    shutil.move(f_out_name,od + f_out_name)
...
if __name__ == '__main__':
    ...
    path_to_mrtbin = 'd:\\blazedata\\dubinin\\tools\\MRT\\bin\\'
    os.environ['MRT_DATA_DIR'] = "d:\\blazedata\\dubinin\\tools\\MRT\\data"
